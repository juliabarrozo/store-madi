...
CREATE TABLE `FavoriteProduct` (
    ...
    UNIQUE INDEX `FavoriteProduct_favoriteId_productId_key`(`favoriteId`, `productId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `ComboProduct` ADD CONSTRAINT `ComboProduct_productAId_fkey` FOREIGN KEY (`productAId`) REFERENCES `Product`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ComboProduct` ADD CONSTRAINT `ComboProduct_productBId_fkey` FOREIGN KEY (`productBId`) REFERENCES `Product`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
